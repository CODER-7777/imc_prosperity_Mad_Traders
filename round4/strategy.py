...
TEMPLATE - Fill in when Round 4 starts.

Carry-forward products and strategies from previous rounds.
Add new round-specific products below.

Workflow:
  1. Analyze round data in data/ folder
  2. Iterate on strategies in the round4/trials branch
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for product, order_depth in state.order_depths.items():
            ...
            # ========================================
            # NEW ROUND 4 PRODUCTS — ADD LOGIC BELOW
            # ========================================
